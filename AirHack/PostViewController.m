...
- (void)loadView
{
    ...
    NSDictionary *views = NSDictionaryOfVariableBindings(_urlField, _postButton);
    ...
    [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-64-[_urlField]-20-[_postButton]" options:0 metrics:nil views:views]];
}
